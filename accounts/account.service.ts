...
async function sendVerificationEmail(account: any, origin: any) {
    ...
    try {
        ...
        console.log('Email sending failed (check SMTP config), but token is logged above');
    }
}
...
async function sendAlreadyRegisteredEmail(email: any, origin: any) {
    ...
    console.log('Use forgot-password route to reset your password');
    console.log('--------------------------------\n');
    ...
    try {
        ...
        console.log('Email sending failed (check SMTP config)');
    }
}
